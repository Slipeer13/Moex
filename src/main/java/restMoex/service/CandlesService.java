...
@Service
public class CandlesService implements MarketService{

    public RootResponse read(String ticker, String fromDate, String toDate) {
        final RestTemplate restTemplate = new RestTemplate();
        String url = "http://iss.moex.com/iss/engines/stock/markets/shares/securities/" + ticker + "/candles.json?from=" + fromDate + "&till=" + toDate + "&interval=10";
